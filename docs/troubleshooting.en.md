...
Both PCs should ideally run the same version. The current mainline version is `v0.1.20`.
...
2. Confirm both sides are on `v0.1.20` or newer.
...
Since `v0.1.20`, arrow keys, Home/End, PageUp/PageDown, Insert/Delete, and related navigation keys use scan-code based extended-key injection. If it still fails:

1. Confirm the remote PC is on `v0.1.20` or newer.
...
- Both sides are on `v0.1.20` or newer.
