...
- 回车、Tab、Esc、Backspace、空格、CapsLock、PrintScreen、F1-F12 等功能键统一走 scan-code 注入
...
当前 0.1.22 安装包位置：
apps/desktop-tauri/src-tauri/target/release/bundle/nsis/Devices Router_0.1.22_x64-setup.exe

当前 0.1.22 局域网更新包位置：
apps/desktop-tauri/src-tauri/target/release/updates/DevicesRouter_0.1.22_x64_setup.exe
