...
当前 0.1.13 安装包位置：
apps/desktop-tauri/src-tauri/target/release/bundle/nsis/Devices Router_0.1.13_x64-setup.exe

当前 0.1.13 局域网更新包位置：
apps/desktop-tauri/src-tauri/target/release/updates/DevicesRouter_0.1.13_x64_setup.exe
apps/desktop-tauri/src-tauri/target/release/updates/manifest.json

优先继续做的事：
1. 真实手测主电脑/副电脑 v0.1.13 自动更新链路。
