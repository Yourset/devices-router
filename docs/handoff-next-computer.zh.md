...
当前 0.1.21 安装包位置：
apps/desktop-tauri/src-tauri/target/release/bundle/nsis/Devices Router_0.1.21_x64-setup.exe

当前 0.1.21 局域网更新包位置：
apps/desktop-tauri/src-tauri/target/release/updates/DevicesRouter_0.1.21_x64_setup.exe
