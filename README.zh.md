...
Devices Router 可以直接转发键盘，不依赖 Logitech Flow 或罗技硬件。`v0.1.30` 为键盘专用稳定版，鼠标能力暂时停用。
...
6. `v0.1.30` 是键盘专用稳定版：鼠标功能暂时停用，使用 `Ctrl+Alt+2` 切到副电脑、`Ctrl+Alt+1` 切回主电脑。
7. 在主电脑输入文字，确认按键出现在副电脑；按 `Ctrl+Alt+1` 后确认键盘恢复到主电脑。
